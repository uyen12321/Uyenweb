        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="admin/home" class="site_title"><span><?=$this->title?></span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="public/build/images/avata-admin.jpg" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span>Xin Chào,</span>
                <h2><?=$this->nameAdmin[0]['full_name']?></h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
