					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 45151117</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> lehuuphuoc@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-md-2 clearfix">
						<div class="logo pull-left">
							<a href="<?=base?>"><img src="public/images/logo/logo3.png" alt="" /></a>
						</div>
					</div>
    		...
    		<div class="row" style="margin-top: 100px;">  	
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>PHUOCMG</p>
							<p>459 Tôn Đức Thắng,quận Liên Chiểu, TP Đà Nẵng</p>
							<p>Số Điện thoại: +84 85151117</p>
							<p>Email: lehuuphuocit0201@gmail.com</p>
	    				</address>
	    			</div>
    			</div>    			
	    	</div>  
